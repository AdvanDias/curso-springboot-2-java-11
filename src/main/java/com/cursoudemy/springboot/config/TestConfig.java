...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Ordem o1 = new Ordem(null, Instant.parse("2020-04-20T19:53:07Z"), u1);
		Ordem o2 = new Ordem(null, Instant.parse("2020-03-21T03:42:10Z"), u2);
		Ordem o3 = new Ordem(null, Instant.parse("2020-02-22T15:21:22Z"), u1);
